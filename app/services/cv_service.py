...
class CVService:
    def __init__(self, cv_repo: CVRepository, cv_details_repo: CVDetailsRepository):
    ...
    def upload_and_parse(self, file_bytes: bytes, filename: str, user_id: UUID):
        ...
        if existing_cv:
            storage.upload_cv_and_get_path(user_id, file_bytes, filename)
        ...
        file_url = storage.get_cv_signed_url(user_id)
